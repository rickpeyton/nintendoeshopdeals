...
def stub_fetch_games_list
  stub_request(:get, "https://www.nintendo.com/json/content/get/filter/game?availability=now&direction=des&limit=40&offset=0&shop=ncom&sort=featured&system=switch") # rubocop:disable Metrics/LineLength
    .with(
      headers: {
        "Accept" => "*/*",
